...
const tourSchema = new mongoose.Schema(
  {
    ...
    // the locations is an embedded document
    locations: [
      {
        type: {
          type: String,
...
// This document middleware is responsible for the embedded document
...
// Query Middleware >> do not find the documents that its secretTour value is set to true
